...
function renderTemplate(tree, root, instance) {
  let result = createTemplateResult.call(this, tree, getValues.call(this, tree, instance));
...
function getValues(tree, instance) {
  ...
  return rawValues.map(value => {
    if (value instanceof Uint8Array) {
      ...
      let val = value[1];
      if (tag === templateTag) {
        return createTemplateResult.call(this, val, getValues.call(this, val, instance));
      }
      return val;
    }
