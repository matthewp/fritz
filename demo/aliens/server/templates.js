  ...
  return hyperscript(
    ...
    hyperscript(
      ...
      hyperscript(
        ...
        hyperscript("animateTransform", { attributeType: "xml", attributeName: "transform", type: "translate", values: "0 0; 0 20; 0 0", begin: "0", dur: "0.6s", repeatCount: "indefinite" })
      ),
      hyperscript(
        "rect",
        { x: "10", y: "0", width: "4", height: "10", fill: "#333", transform: "translate(0 4.44444)" },
        hyperscript("animateTransform", { attributeType: "xml", attributeName: "transform", type: "translate", values: "0 0; 0 20; 0 0", begin: "0.2s", dur: "0.6s", repeatCount: "indefinite" })
      ),
      hyperscript(
        "rect",
        { x: "20", y: "0", width: "4", height: "10", fill: "#333", transform: "translate(0 8.88889)" },
        hyperscript("animateTransform", { attributeType: "xml", attributeName: "transform", type: "translate", values: "0 0; 0 20; 0 0", begin: "0.4s", dur: "0.6s", repeatCount: "indefinite" })
      )
    )
  );
};
